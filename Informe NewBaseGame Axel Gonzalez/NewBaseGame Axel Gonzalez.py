    ...
    for y in range(0, nxC):
        for x in range (0, nyC):
           ...
           # Si la celda está "viva" pintamos un recuadro relleno de color
                ...
                pygame.draw.polygon(screen, (0, 255, 34), poly, 0)
            elif gameState[x, y] == 2:
                pygame.draw.polygon(screen, (32, 217, 230), poly, 0)
            else:
                pygame.draw.polygon(screen, (32, 45, 230), poly, 0) #color
